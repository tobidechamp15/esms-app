...
export default function PendingApprovalScreen() {
  ...
  const s = StyleSheet.create({
    ...
    title: { fontSize: 24, fontWeight: '700', color: theme.text, textAlign: 'center', marginBottom: Spacing.two },
    body: { fontSize: 15, color: theme.textSecondary, textAlign: 'center', lineHeight: 22, marginBottom: Spacing.five },
    ...
    secondaryBtnText: { fontSize: 14, color: theme.textSecondary, fontWeight: '600' },
  });
    ...
    <SafeAreaView style={s.container}>
      <View style={s.inner}>
        ...
        <Text style={s.body}>
          ...
          You&apos;ll receive a notification once your account is approved. This usually takes
          24–48 hours.
        </Text>
        ...
        <Pressable
          ...
          disabled={isLoading}>
          <Text style={s.primaryBtnText}>{isLoading ? 'Checking…' : 'Check status'}</Text>
        </Pressable>
